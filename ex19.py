...
cronometro= 10 #definimos uma variável que representa o cronómetro com 10 segundos
...
while True: #inicia-se o ciclo infinito
    ...
    if cronometro2<=1: #INTRODUZIMOS A CONDIÇÃO QUE VAI QUEBRAR O CICLO!
        ...
        break
#ORDEM IMPERATIVA que o ciclo vai PARAR. SE COLOCARMOS CÓDIGO DEPOIS DO BREAK (mais ainda dentro do ciclo) NÃO VAI SER EXECUTADO!
